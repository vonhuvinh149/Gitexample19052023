...
class ProductHistoryAdapter(private val products: MutableList<Product>) :
    ...
    inner class ProductHistoryViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(product: Product) {
            ...
            tvTotalPriceProduct.text = (product.price * product.quantity).toString()
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductHistoryViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val view = layoutInflater.inflate(R.layout.layout_product_item_history_order, parent, false)
